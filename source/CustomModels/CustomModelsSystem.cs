...
public sealed class CustomModelsSystem : ModSystem
{
    ...
    private void LoadDefault()
    {
        ...
        CustomModelData defaultModelData = new(_defaultModelCode, defaultShape)
        {
            ...
            AddTags = TagSetFast.Empty,//_api.EntityTagRegistry.CreateTagSet(defaultConfig.AddTags as IEnumerable<string>),
            RemoveTags = TagSetFast.Empty,//_api.EntityTagRegistry.CreateTagSet(defaultConfig.RemoveTags as IEnumerable<string>),
    ...
    private void LoadCustomModel(ICoreAPI api, string code, CustomModelConfig modelConfig)
    {
        ...
        CustomModelData modelData = new(code, shape)
        {
            ...
            AddTags = TagSetFast.Empty,// api.EntityTagRegistry.CreateTagSet(modelConfig.AddTags as IEnumerable<string>),
            RemoveTags = TagSetFast.Empty,// api.EntityTagRegistry.CreateTagSet(modelConfig.RemoveTags as IEnumerable<string>),
